<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="pendingBookings.aspx.cs" Inherits="roomBooking.pendingBookings" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="roomContainer">
        ...
        <asp:Repeater ID="RepeaterPendingBookings" runat="server">
            <ItemTemplate>
                <div class="room">
                    ...
                    <p>Total Bill: <span>
                            <%# CalculateTotalBill(Eval("stayDays"), Eval("RoomId"),
                                ConfigurationManager.ConnectionStrings["hotelRooms"].ConnectionString) %>
                        </span></p>
                </div>
    </div>
    </ItemTemplate>
...
max-width: 300px;height:50px;border-radius: 5px;text-align:center;background-color: gold;color: black;font-family:'DM sans';font-weight: 600;;" />
</div>
</div>
</asp:Content>
